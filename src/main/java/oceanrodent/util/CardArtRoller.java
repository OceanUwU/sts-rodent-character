...
public class CardArtRoller {
    private static final Texture attackMask = TexLoader.getTexture(RodentMod.makeImagePath("masks/AttackMask.png"));
    private static final Texture skillMask = TexLoader.getTexture(RodentMod.makeImagePath("masks/SkillMask.png"));
    private static final Texture powerMask = TexLoader.getTexture(RodentMod.makeImagePath("masks/PowerMask.png"));
